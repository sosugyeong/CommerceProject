...
public class Main {
    public static void main(String[] args) {
        ...
        elecProducts.add(new Product("Galaxy S25", 1200000, 25, "최신 안드로이드 스마트폰"));
        elecProducts.add(new Product("iPhone 16", 1350000, 30, "Apple의 최신 스마트폰"));
        elecProducts.add(new Product("MacBook Pro", 1350000, 15, "M3 칩셋이 탑재된 노트북"));
        elecProducts.add(new Product("AirPods Pro", 350000, 50, "노이즈 캔슬링 무선 이어폰"));

        //식품 카테고리에 들어갈 상품 리스트
        List<Product> foodProducts = new ArrayList<>();
        foodProducts.add(new Product("딸기", 15000, 30, "맛있는 설향딸기"));
